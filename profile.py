...
# Pick your OS.
imageList = [
    ('urn:publicid:IDN+emulab.net+image+emulab-ops//UBUNTU20-64-STD', 'Default Image'),
...
for i in range(params.nodeCount):
    ...
    node.addService(pg.Execute(shell = "bash", command = '/local/repository/ksplit-top.sh'))
